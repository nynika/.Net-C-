...
namespace DALayer
{
    public class DataLayer
    {
        ...
        protected SqlDatabase db_Institution_Live;
        protected SqlDatabase db_Business;
        protected SqlDatabase db_EMR;
        protected SqlDatabase db_IP;
        ...
        protected SqlDatabase RMC_IP_Live;
        protected SqlDatabase db_RMC_PACS_Interface;
        protected SqlDatabase db_RMC_EMR_Demo;
        protected SqlDatabase db_RMC_EMR_Live;
        protected SqlDatabase db_RMC_Masters_Live;
        ...
        public DataLayer()
        {
            ...
            db_Institution_Live = new SqlDatabase(ConfigurationManager.AppSettings["CStrRIMC_Institution_Live"]);
            db_EMR = new SqlDatabase(ConfigurationManager.AppSettings["CStrRIMC_EMR"]);
            db_IP = new SqlDatabase(ConfigurationManager.AppSettings["CStrRIMC_IP"]);
            ...
            //db_SQLMasterTest = new SqlDatabase(ConfigurationManager.AppSettings["CStrRIMC_SQLMaster_Test"]);
            //db_Business = new SqlDatabase(ConfigurationManager.AppSettings["CStrRIMC_Business"]);
            //db_PACS_Interface = new SqlDatabase(ConfigurationManager.AppSettings["CStrRMC_PACS_Interface"]);
            ...
            db_RMC_EMR_Demo = new SqlDatabase(ConfigurationManager.AppSettings["cstrdwRMC_EMR_Demo"]);
            db_RMC_EMR_Live = new SqlDatabase(ConfigurationManager.AppSettings["cstrdwRMC_EMR_Live"]);
            // db_HelpDeskIT = new SqlDatabase(ConfigurationManager.AppSettings["CStrRIMC_HelpDesk_IT"]);
            ...
            RMC_IP_Live = new SqlDatabase(ConfigurationManager.AppSettings["CStr_RMC_IP_Live"]);
            db_RMC_Masters_Live = new SqlDatabase(ConfigurationManager.AppSettings["CStr_RMC_Masters_Live"]);
        }
...

        {
            ...
            try
            {
                using (DbCommand Cmd = db_IP.GetStoredProcCommand(MediDBConstants.House_Keeping_List_Save))
                {
...

        {
            ...
            try
            {
                using (DbCommand Cmd = db_IP.GetStoredProcCommand(MediDBConstants.RestRoom_Check_List_Save))
                {
        ...
        public DataSet SurgProcname_Dtl()//Sujithra 30/12/2023
        {
            ...
            try
            {
                using (DbCommand cmd = db_IP.GetStoredProcCommand(MediDBConstants.SP_SurgProcname_Dtl))
                {
                    cmd.CommandTimeout = 30;
                    ds = db_IP.ExecuteDataSet(cmd);
                };
        ...
        public DataSet FinancialCounsellingprint(int Patientid, int CounsellingId)//Sujithra 30/12/2023
        {
            ...
            try
            {
                using (DbCommand Cmd = db_IP.GetStoredProcCommand(MediDBConstants.SP_FinancialCounsellingprint))
                {
        ...
        public DataSet FinancialCounsellingprint(int Patientid)//Sujithra 02/01/2023
        {
            ...
            try
            {
                using (DbCommand Cmd = db_IP.GetStoredProcCommand(MediDBConstants.Sp_FinCouncil_Detail_Load))
                {
        ...
        public DataSet Web_Bed_Report()
        {
            ...
            try
            {
                using (DbCommand Cmd = RMC_IP_Live.GetStoredProcCommand(MediDBConstants.GetBed_Report))
                {
                   
                    Cmd.CommandTimeout = 30;
                    ds = RMC_IP_Live.ExecuteDataSet(Cmd);
                };
            }
            catch (Exception ex)
            {
        ...
        public DataSet web_refincoun_save(clsrefincoun request)
        {
            ...
            try
            {
                using (DbCommand Cmd = db_IP.GetStoredProcCommand(MediDBConstants.SP_web_refincoun_save))
                {
        ...
        public DataSet IPBedBlock_Save(clsIPBedBlock request)
        {
            ...
            try
            {
                using (DbCommand Cmd = db_IP.GetStoredProcCommand(MediDBConstants.SP_IP_IPBedBlock_Save))
                {
        ...
        public DataSet IPBedBlock_Clear(reqIPBedBlock_Clear request)
        {
            ...
            try
            {
                using (DbCommand Cmd = db_IP.GetStoredProcCommand(MediDBConstants.SP_IPBedBlock_Clear))
                {
        ...
        public DataSet Package_Patient_venue()
        {
            ...
            try
            {
                using (DbCommand cmd = db_RMC_Masters_Live.GetStoredProcCommand(MediDBConstants.Sp_Package_Patient_venue))
                {
                    cmd.CommandTimeout = 30;
                    ds = db_RMC_Masters_Live.ExecuteDataSet(cmd);
        ...
        public DataSet BedRateAndNursingRate_dtl(int Bedcategoryid)
        {
            ...
            try
            {
                using (DbCommand cmd = db_IP.GetStoredProcCommand(MediDBConstants.SP_BedRateAndNursingRate_dtl))
                {
        ...
        public DataSet web_sp_BedDetails_Load(int CatId) 
        {
            ...
            try
            {
                using (DbCommand cmd = db_IP.GetStoredProcCommand(MediDBConstants.sp_BedDetails_Load))
                {
        ...
        public DataSet web_sp_Get_BedID(int BedId)
        {
            ...
            try
            {
                using (DbCommand cmd = db_IP.GetStoredProcCommand(MediDBConstants.sp_Get_BedID))
                {
        ...
        public DataSet BedBlockDetails_Load()
        {
            ...
            try
            {
                using (DbCommand Cmd = db_IP.GetStoredProcCommand(MediDBConstants.Sp_BedBlockDetails_Load))
                {
                    Cmd.CommandTimeout = 30;
                    ds = db_IP.ExecuteDataSet(Cmd);
                };
...

        {
            ...
            try
            {
                using (DbCommand Cmd = db_IP.GetStoredProcCommand(MediDBConstants.SP_FinancialCounselling))
                {
                    param = new SqlParameter("@Patientid", request.Patientid);
                    param.Direction = ParameterDirection.Input;
                    param.DbType = DbType.Int64;
        ...
        public DataSet updateOnlinePayment(payment_request request)
        {
            DataSet ds = new DataSet();
            SqlParameter param;
            try
        ...
        public DataSet Kranium_EMRAPILog(string Fdate, string tdate, string Status)
        {
            ...
            try
            {
                using (DbCommand Cmd = db_RMC_EMR_Live.GetStoredProcCommand(MediDBConstants.SP_Kranium_EMRAPILog))
                {
                    ...
                    ds = db_RMC_EMR_Live.ExecuteDataSet(Cmd);
                };
            }
            catch (Exception ex)
            {
        ...
        //    try
        //    {
        //        using (DbCommand Cmd = db_Institution_Live.GetStoredProcCommand(MediDBConstants.sp_opd_Process_Get))
        //        {
        //            param = new SqlParameter("@Todate", Todate);
        //            param.Direction = ParameterDirection.Input;
        //            param.DbType = DbType.String;
        ...
        //            ds = db_Institution_Live.ExecuteDataSet(Cmd);
        //        };
        //    }
        //    catch (Exception ex)
        //    {
        ...
        public DataSet Get_opd_Process_v1(string Todate, int Type)
        {
            ...
            try
            {
                using (DbCommand Cmd = db_Institution_Live.GetStoredProcCommand(MediDBConstants.sp_opd_Process_Get_v1))
                {
                    param = new SqlParameter("@Todate", Todate);
                    param.Direction = ParameterDirection.Input;
                    param.DbType = DbType.String;
        ...
        public DataSet UpdateQCEMRDashboard_Visit(string Todate, int VisitId)          
        {
            ...
            try
            {
                using (DbCommand Cmd = db_Institution_Live.GetStoredProcCommand(MediDBConstants.sp_qcupdate_visit))
                {
                    param = new SqlParameter("@Todate", Todate);
                    param.Direction = ParameterDirection.Input;
                    param.DbType = DbType.String;
        ...
        public DataSet SaveOrUpdateQCVisittracking(req_Visittracking request)
        {
            ...
            try
            {
                using (DbCommand Cmd = db_Institution_Live.GetStoredProcCommand(MediDBConstants.sp_QCvisit))
                {
        ...
        public DataSet SaveOrUpdateQCOrderTracking(req_OrderTracking request)
        {
            ...
            try
            {
                using (DbCommand Cmd = db_Institution_Live.GetStoredProcCommand(MediDBConstants.sp_QCorder))
                {
